# Starter Story 单竞品来源核验

> 日期：2026-08-18  
> 目的：为 `research/codex/2026-08-18-Codex-Starter-Story单竞品商业解剖.md` 提供原始来源映射  
> 注意：公司官网、创始人自述与匿名评价不能自动升级为独立市场事实

## 一、高负重结论账本

| 编号 | 结论 | 标签 | 完整来源与属性 | 利益关系 | 能证明什么 | 不能证明什么 | 原文状态 | 反证条件 |
|---|---|---|---|---|---|---|---|---|
| SS-01 | HubSpot 在 2026 Q1 收购 Starter Story | `F-M` | [HubSpot Q1 2026 Earnings Call Transcript](https://ir.hubspot.com/static-files/a4c0bbe9-83ff-47b3-89f6-259fecf58a2e)，上市公司投资者材料 | 收购方有宣传交易合理性的利益 | 收购行为发生；管理层称其用于扩展 top-of-funnel | 收购价格、Starter Story 利润、收购后 ROI | 已核原文 | HubSpot 更正或监管披露否定交易 |
| SS-02 | HubSpot 将 Starter Story 视为上游获客/媒体资产 | `F-P` | 同上；另见 [HubSpot for Startups 收购公告](https://www.linkedin.com/posts/hubspot-for-startups_today-were-sharing-some-big-news-hubspot-activity-7431761509485195264-V8wL)，公司官方账号 | 收购方希望强调协同价值 | 官方战略意图；看重网站、newsletter、YouTube、社区与档案 | 协同已经实现；具体获客成本下降多少 | 已核原文 | 后续披露显示资产另作他用或被关闭 |
| SS-03 | 当前首页以免费邮件注册提供 startup data，展示 2,992+ 项目 | `F-P` | [Starter Story 首页](https://www.starterstory.com/)，公司产品页 | 公司希望扩大注册 | 当前公开入口、定位与页面计数 | 每个项目收入真实性、活跃使用、转化、更新成本 | 已核原文 | 页面或产品条款变更 |
| SS-04 | 当前仍有 Academy、Bootcamp 和 AI 训练等付费层 | `F-P` | [Academy 结账页](https://www.starterstory.com/checkout?plan=academy&promo=PRESIDENTSDAY30)、[AI Build Training 结账页](https://www.starterstory.com/checkout?plan=ai_build_training)、[Build](https://build.starterstory.com/)、[Bootcamp 结账页](https://build.starterstory.com/checkout?plan=first_sale_bootcamp&promo=LASTCHANCE75) | 公司直接销售 | 挂牌价格、交付清单与购买入口存在 | 实际成交价分布、销量、利润、完成与退款 | 已核原文 | 结账失效或产品撤下 |
| SS-05 | 历史商业模式包含会员、广告/赞助、联盟分成 | `F-P` | [How We Work](https://www.starterstory.com/how-we-work)，公司说明；[Pat Walls 长篇复盘](https://patwalls.com/)，创始人自述 | 创始人/公司有展示成功的利益 | 历史自述的商业结构与演变 | 2026 当前收入占比；审计后的真实收入 | 已核原文 | 财务或交易材料显示结构不同 |
...
| 产品/入口 | 2026-08-18 可见口径 | 证据边界 |
|---|---|---|
| Startup data | 邮箱注册后免费访问；首页称 2,992+ 项目、39 个数据库 | 页面主张，不证明逐条核验或活跃使用 |
| Academy | 499 美元/年；检索时页面展示 99 美元促销 | 挂牌/促销，不证明成交分布与续费 |
| AI Build Training | 195 美元一次性；可见 99 美元加购 | 挂牌，不证明销量 |
| First Sale Bootcamp | 395 美元一次性；检索时促销合计 320 美元 | 挂牌，不证明实际效果 |
| Subscription/one-time services | [Subscription Terms](https://www.starterstory.com/subscription-terms) 允许订阅和一次性服务，通常不退款，并已引用 HubSpot 条款 | 法律/产品边界，不证明客户体验 |
...
- 创始人称以采访朋友和网上找到的创业者起步；
- Reddit 带来早期读者、邮件订阅、赞助商和更多采访对象；
- 2019 年创始人称达到约 100K 月访问并依靠自由职业者扩大采访产量。
...
- HubSpot 在 Q1 收购；
- 当前首页显示 2.0 Beta 和免费数据邮箱入口；
- 付费 Academy、Bootcamp、AI training 仍有可用结账页；
- 当前收入组合、用户转化和 HubSpot 产品导流结果均为 `Ø`。

没有找到官方材料证明“收购直接导致数据库免费化”，只能记为时间上的并存，不写因果。

## 四、当前必须保持为 `Ø` 的空格

1. 收购价格与交易具体条款；
2. 2026 年当前收入、利润及各业务占比；
3. 当前真实付费会员数、续费率、流失率和 CAC；
4. 免费数据库到 Academy、Build 或 HubSpot CRM 的转化率；
5. 每个案例的收入核验、更新频率、错误率和编辑人工；
6. Bootcamp/Academy 的完成率、首次成交率、退款率与结果分布；
...
- HubSpot 业绩会与 HubSpot 官方 LinkedIn 属于同一公司来源，不能算两条独立验证；
- Pat Walls 官网、LinkedIn、Indie Hackers 访谈均以创始人本人为事实源，重复不等于独立验证；
- 官网中的用户成功案例为厂商筛选材料，不能与 Trustpilot/Reddit简单平均；
...
> HubSpot 在 2026 年第一季度收购 Starter Story，并在业绩会上把它列为扩展上游获客的媒体资产之一。`F-M/F-P`

不能写：

> Starter Story 因案例数据库利润高而被高价收购。

可以写：

> Starter Story 当前同时存在免费数据入口与 499 美元/年 Academy、195 美元训练和 395 美元 Bootcamp 的挂牌层。`F-P`
